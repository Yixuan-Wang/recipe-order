...
class ModelPerm(nn.Module):
    def __init__(self):
        ...
        self.bert: PreTrainedModel = AutoModel.from_pretrained(env.PRETRAINED_MODEL_PERM)
    ...
    def forward(self, input: DataBatchPerm):
        bert_output: BaseModelOutputWithPoolingAndCrossAttentions = self.bert(**input.get_input())
